  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: const Center(
          // sol tarafta çıkan ampul işaretiyle widget haline getirebiliriz.
          // mesela extract widget diyince tıpkı sayfa gibi yapı oluşturur.
          // bu yapıyı farklı sayfa içine atıp import edebiliriz.
          child: Column(
            children: [
